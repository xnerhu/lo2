...
import { StyledItem, Map } from './style';
...
const Policy = () => {
  return (
    <Content>
      <SectionTitle>Klauzula informacyjna</SectionTitle>
      ...
      (ogólne rozporządzenie o ochronie danych) o ochronie danych osobowych z
      ...
      <ul>
        <li>
          Zespół Szkół Ogólnokształcących Nr II w Opolu, ul. Pułaskiego 3,
          45-048 Opole
        </li>
      </ul>
      Dane kontaktowe inspektora ochrony danych osobowych:
      aleksandra.taskin@lo2.opole.pl
      <br />
      <br />
      Pani/Pana dane osobowe i dane osobowe Pani/Pana dziecka przetwarzane będą,
      na podstawie odpowiednich przepisów prawa lub odrębnie zbieranych zgód, w
      celach:
      <ul>
      ...
      Pani/Pana dane osobowe i dane osobowe Pani/Pana dziecka będą przechowywane
      przez okres wymagany przepisami prawa (Rozporządzenie Ministra Edukacji
      Narodowej z dnia 25 sierpnia 2017 r. w sprawie sposobu prowadzenia przez
      ...
      maksymalnie 50 lat od zakończenia nauki w Zespole Szkół Ogólnokształcących
      Nr II w Opolu posiada Pani/Pan prawo dostępu do treści swoich danych oraz
      ...
      <br />
      <br />
      Ma Pan/Pani prawo wniesienia skargi do Prezesa UODO, gdy uzna Pani/Pan, iż
      przetwarzanie danych osobowych dotyczących Pani/Pana narusza przepisy
      Rozporządzenia o ochronie danych osobowych z dnia 27.04.2016r.
      <br />
      <br />
      Podanie przez Pana/Panią danych osobowych jest wymogiem ustawowym (ustawa
      Prawo oświatowe, ustawa o systemie oświaty). Jest Pan/Pani zobowiązana do
      ich podania a konsekwencją niepodania danych osobowych będzie
      niezrealizowanie celów, w jakich zbierane są dane osobowe.
    </Content>
  );
};
...
export default () => {
  return (
    <>
      <Background>
        <Content>
          <SectionTitle selectable>
            Publiczne Liceum Ogółnokształcące nr II z Oddziałami Dwujęzycznymi w
            Opolu
          </SectionTitle>
          <div>
            <Item label="Adres">ul. Kazimierza Pułaskiego 3</Item>
            <Item label="Kod pocztowy">45-048 Opole</Item>
            <Item label="E-mail">sekretariat@lo2.opole.pl</Item>
            <Item label="Tel./Fax.">(0-77) 454-22-86, 402-18-87</Item>
            <Item label="Godziny otwarcia sekretariatu">
              700 ÷ 1500 w dni powszednie
            </Item>
            <Item label="NIP">754-111-03-47</Item>
            <Item label="REGON">160 347 099</Item>
            <Item label="Konto Rady Rodziców">
