...
import { Image as DynamicImage, IImageProps } from '~/renderer/components/Image';
import { SectionTitle } from '~/renderer/components/Section';
import { StyledHistory, Container, MastersContainer } from './style';

const Image = ({ src, style, children }: IImageProps) => {
  return <DynamicImage src={src} style={{ ...style, borderRadius: 8 }} skeletonBorder={8} shadow jpgOnly>{children}</DynamicImage>;
}
...
const HistorySection = () => {
  return (
    ...
    <br />
      ...
      <Container>
        <Image src='/static/history/header' style={{ width: 200, height: 136 }} />
        <Image src='/static/history/grono' style={{ width: 200, height: 132, marginBottom: 32 }}>
          <b>Grono pedagogiczne (wrzesień 1946)</b>
        </Image>
        <Image src='/static/history/maturzystki' style={{ width: 200, height: 132, marginBottom: 48 }}>
      ...
      <Container>
        <Image src='/static/history/header2' style={{ width: 200, height: 132 }} />
      </Container>
      <br />
      <br />
      ...
      <Container>
        <Image src='/static/history/patron' style={{ width: 133, height: 252 }} />
        <Image src='/static/history/patron2' style={{ width: 163, height: 258 }} />
      </Container>
      <br />
...
const HeadermastersSection = () => {
  return (
    <>
      ...
      <MastersContainer>
        <Master name='mgr Franciszek Pedela' src='/static/history/pedela' style={{ width: 142, height: 198 }}>
          maj 1945 - sierpień 1945
        </Master>
        <Master name='mgr Maria Tyszkiewicz' src='/static/history/tyszkiewicz' style={{ width: 138, height: 204 }}>
          sierpień 1945 - wrzesień 1950
        </Master>
        <Master name='Helena Małecka' src='/static/history/malecka' style={{ width: 140, height: 205 }}>
          wrzesień 1950 - sierpień 1963
        </Master>
        <Master name='mgr Antoni Cięciel' src='/static/history/cieciel' style={{ width: 138, height: 204 }}>
          sierpień 1963 - październik 1966
        </Master>
        <Master name='mgr Witalis Brągiel' src='/static/history/bragiel' style={{ width: 141, height: 204 }}>
          październik 1966 - sierpień 1977
        </Master>
        <Master name='dr Stanisław Palej' src='/static/history/palej' style={{ width: 137, height: 187 }}>
          sierpień 1982 - sierpień 1991
        </Master>
        <Master name='mgr Michał Paterak' src='/static/history/peterak' style={{ width: 140, height: 197 }}>
