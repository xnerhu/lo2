      ...
      <Content>
        ...
        <Container>
          <Text>
            ...
            Zapiórkiewicza przy obecnej ul. Kościuszki 31 (dawniej
            Petersburskiej 200).
            <br />
            <br />
            ...
            Jarosław, Laura Celina, Zofia i Jadwiga Julia. Zofia zmarła
            nazajutrz po urodzeniu i została pochowana na suwalskim cmentarzu.
            We wrześniu 1849 roku Wasiłowscy opuścili Suwałki i udali się do
            Kalisza. Józef Wasiłowski objął tam takie samo stanowisko jak w
            Suwałkach. W Kaliszu w 1850 roku przyszła na świat najmłodsza
            siostra Marii - Celina Maria. W cztery lata później Scholastyka
            Wasiłowska osierociła liczną gromadkę dzieci. Po latach pisarka
            będzie często wspominać smutne sieroce dzieciństwo, trudne
            obowiązki, które spadły na najstarsze dzieci, a więc i na nią.
            <br />
            <br />
            Rok tylko była Maria na pensji Sakramentek w Warszawie i tam
            zetknęła się z Lizą Pawłowską, późniejszą Orzeszkową. Przyjaźń ich,
            scementowana wspólnymi zainteresowaniami literackimi, przetrwała
            całe życie.
            <br />
            <br />
            ...
            uczestniczenia w życiu towarzyskim Konopnicka zapragnęła poświęcić
            się pisarstwu. Debiutowała w 1875 roku wierszem w "Kaliszaninie".
            Cykl lirycznych wierszy "W górach" zamieścił w rok później "Tygodnik
            ...
            przepełniona patriotyzmem i szczerym liryzmem, stylizowana "na
            swojską nutę" zdobyła powszechne uznanie. Już w latach 1881, 1883 i
            1886 ukazały się trzy kolejne serie poezji. Ten rodzaj twórczości
            ...
            twórczości otrzymała w darze od narodu dworek w Żarnowcu koło
            Krosna. Już jako znana pisarka powróciła Konopnicka do wspomnień z
            lat dzieciństwa spędzonych w Suwałkach. Poświęciła im dwa utwory: "Z
            ...
            społeczeństwem Suwałk. Zorganizowano wieczór poświęcony jej
            twórczości i zapoczątkowano zbiórkę pieniędzy na tablicę pamiątkową.
            Władze carskie sprzeciwiły się tej inicjatywie.
            <br />
            <br />
            Dopiero w 25-lecie śmierci - 8 października 1935 roku na domu, w
            którym się poetka urodziła wmurowano pamiątkową tablicę. W 1963
            roku, staraniem nauczycieli suwalskich i Zarządu Głównego
            Towarzystwa im. Marii Konopnickiej w Warszawie oraz dzięki wsparciu
            finansowemu Społecznego Funduszu Odbudowy Stolicy, odsłonięto pomnik
            dłuta Bohdana Chmielewskiego. W dziesięć lat później w sierpniu 1973
            roku zorganizowano Muzeum Marii Konopnickiej.
          </Text>
